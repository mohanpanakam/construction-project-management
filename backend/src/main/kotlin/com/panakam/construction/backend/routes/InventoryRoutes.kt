...
fun Route.inventoryRoutes(dynamoDbClient: DynamoDbClient) {
    ...
    route("/inventory") {
        ...
        post {
            ...
            call.respond(HttpStatusCode.Created, mapOf("message" to "Inventory item added", "projectId" to projectId))
        }
